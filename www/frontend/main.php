...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
   ...
   <script src="_files/pixel.js" type="text/javascript"></script>
   </head>
...
<br><center>
		...
		<a href="frontend/help.php">
<li class="idea-gallery__item" data-modal-target="gallery-item-2" data-share-image="" data-id="88795" style="height: 476px;">
<img src="_files/1.jpg" alt="" class="idea-gallery__img" style="min-height: 100%; min-width: 100%; max-width: 300%; max-height: 100%; top: 0px; object-fit: cover; left: -119px;">
<div class="idea-gallery__name-wrapper">
	<h3 class="idea-gallery__name">Деревенька</h3>
</div>
	<div class="idea-gallery__item-wrapper">
		<div class="idea-gallery__content">Необходима помощь</div>
											</div>
											</div>
											</li></a>
											
		<a href="frontend/want.php">
<li class="idea-gallery__item" data-modal-target="gallery-item-2" data-share-image="" data-id="88795" style="height: 476px;">
<img src="_files/2.jpg" alt="" class="idea-gallery__img" style="min-height: 100%; min-width: 100%; max-width: 300%; max-height: 100%; top: 0px; object-fit: cover; left: -119px;">
<div class="idea-gallery__name-wrapper">
	<h3 class="idea-gallery__name">Волонтер</h3>
</div>
	<div class="idea-gallery__item-wrapper">
		<div class="idea-gallery__content">Желаю помочь</div>
 

											</div>
											</div>
											</li></a>
		<a href="frontend/service.php">
<li class="idea-gallery__item" data-modal-target="gallery-item-2" data-share-image="" data-id="88795" style="height: 476px;">
<img src="_files/3.jpg" alt="" class="idea-gallery__img" style="min-height: 100%; min-width: 100%; max-width: 300%; max-height: 100%; top: 0px; object-fit: cover; left: -119px;">
<div class="idea-gallery__name-wrapper">
	<h3 class="idea-gallery__name">Общий каталог</h3>
</div>
	<div class="idea-gallery__item-wrapper">
		<div class="idea-gallery__content ">Услуги</div>
</li></a>
